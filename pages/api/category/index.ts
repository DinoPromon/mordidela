...
import { FindAllCategories } from "@controllers/category";
  ...
  try {
    ...
    switch (req.method) {
      case ReqMethod.GET: {
        ...
        const findAllCategories = new FindAllCategories({ getDeleted }, paginationArg);
        const allCategories = await findAllCategories.exec();
